...
namespace cubic_spline_planner{
    ...
    std::vector<InterpolatedPoint> Spline::InterpolateXYWithYaw(const std::vector<double>& xs, const std::vector<double>& ys, int count){
        if (xs.size() != ys.size()) {
    ...
    std::vector<InterpolatedPoint> Spline::InterpolateYaw(const std::vector<double>& xOrig, const std::vector<double>& xs, const std::vector<double>& ys, const std::vector<double>& xInterp) {
